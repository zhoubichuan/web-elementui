...
<web-row>
  <web-button icon="el-icon-search" circle></web-button>
  <web-button type="primary" icon="el-icon-edit" circle></web-button>
  <web-button type="success" icon="el-icon-check" circle></web-button>
  <web-button type="info" icon="el-icon-message" circle></web-button>
  <web-button type="warning" icon="el-icon-star-off" circle></web-button>
  <web-button type="danger" icon="el-icon-delete" circle></web-button>
</web-row>
```
